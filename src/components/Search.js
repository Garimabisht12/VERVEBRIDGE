...
// The Place component allows users to search for a city and update the app's context with the selected location.
                ...
                <div className="results-container">
                    {
                        searchResults.map((place)=>{
                            <div className="result" key={place.place_id} onClick={() =>changePlace(place)}>
                                {place.name}, {place.placeadm_area1}, {place.country}
                            </div>
